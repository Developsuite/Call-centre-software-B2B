...
export default function AdminDashboardPage() {
 ...
 className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold hover:bg-blue-200 dark:hover:bg-blue-500/20 transition-all"
 ...
 className="h-9 px-3 text-sm font-bold bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border rounded-lg outline-none focus:ring-1 focus:ring-[#ff5a36] text-slate-800 dark:text-white cursor-pointer w-full"
 >
 ...
 className={cn("px-4 py-2 rounded-lg text-xs font-bold transition-all", filterType === "all" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36]" : "text-slate-500 hover:text-slate-800 dark:hover:text-white")}
 >
 Company Wide
 </button>
 <button 
 onClick={() => handleFilterTypeChange("team")}
 className={cn("px-4 py-2 rounded-lg text-xs font-bold transition-all", filterType === "team" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36]" : "text-slate-500 hover:text-slate-800 dark:hover:text-white")}
 >
 By Team
 </button>
 <button 
 onClick={() => handleFilterTypeChange("agent")}
 className={cn("px-4 py-2 rounded-lg text-xs font-bold transition-all", filterType === "agent" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36]" : "text-slate-500 hover:text-slate-800 dark:hover:text-white")}
 >
 By Agent
 </button>
 <button 
 onClick={() => handleFilterTypeChange("processor")}
 className={cn("px-4 py-2 rounded-lg text-xs font-bold transition-all", filterType === "processor" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36]" : "text-slate-500 hover:text-slate-800 dark:hover:text-white")}
 >
 By Processor
 </button>
 </div>
 ...
 className="mt-2 h-9 px-3 text-sm font-bold bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border rounded-lg outline-none focus:ring-1 focus:ring-[#ff5a36] text-[#ff5a36] cursor-pointer w-full"
 >
 ...
 <Card className="rounded-[1.5rem] p-5 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border-none flex flex-col justify-between">
 ...
 <Card className="rounded-[1.5rem] p-6 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border-none flex flex-col mb-4">
 ...
 <span className="-ml-6 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 px-1 absolute">{i === 0 ? 0 : 'Max'}</span>
 </div>
 ))}
 </div>
 ...
 {/* Agent Leaderboard */}
 <Card className="rounded-[2rem] border-none bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 flex flex-col overflow-hidden">
 ...
 <Card className="rounded-[2rem] border-none bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 flex flex-col overflow-hidden mt-6">
 <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-transparent">
 <div className="flex items-center gap-3">
