...
export default function TeamsListPage() {
 ...
 className="bg-[#ff5a36] hover:bg-[#ff5a36]/90 text-white rounded-full h-9 px-4"
 >
 ...
 <Card className="rounded-[1.5rem] p-5 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border border-slate-200 dark:border-slate-800 hover:shadow-md transition-shadow cursor-pointer flex flex-col h-full">
