...
export default function AdminDashboard() {
 ...
 {/* Main Action Card */}
 <Card className="rounded-[1.5rem] border-none bg-gradient-to-br from-[#404040] to-[#111111] dark:from-[#2e3440] dark:to-[#0f172a] p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[220px]">
 ...
 <Card className="rounded-[1.25rem] border-none bg-card p-5 flex flex-col justify-between relative overflow-hidden group">
 ...
 <Card className="rounded-[1.5rem] border-none bg-card overflow-hidden">
 <div className="p-5">
