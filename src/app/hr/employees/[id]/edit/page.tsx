...
export default function EditHREmployeePage() {
  ...
  const { hrEmployees, updateHREmployee, currentUser, teams, isLoaded } = useAppContext()
  ...
  const [formData, setFormData] = useState({
    ...
    status: "Active" as "Active" | "Disabled" | "Documents Missing" | "Resigned" | "Left",
    zk_user_id: ""
  })
  ...
  useEffect(() => {
    if (isLoaded && employeeId) {
        const emp = hrEmployees.find(e => e.id === employeeId)
        if (emp) {
            setFormData({
  ...
  }, [isLoaded, employeeId, hrEmployees])
  ...
  return (
    <DashboardLayout title="Edit Employee Record">
            ...
            <div className="flex flex-col flex-1 mt-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <select 
                    ...
                    onChange={(e) => setFormData({ ...formData, status: e.target.value as "Active" | "Disabled" | "Documents Missing" | "Resigned" | "Left" })}
                >
