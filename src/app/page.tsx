...
export default function SalesAgentDashboard() {
 ...
 <Card className="rounded-[1.5rem] lg:col-span-4 border-none overflow-hidden flex flex-col justify-between p-5">
 ...
 <Card className="rounded-[1.25rem] border-none bg-card p-3 flex flex-col justify-between">
 <div className="flex justify-between items-start">
 ...
 {/* Chart Card */}
 <Card className="rounded-[1.5rem] lg:col-span-4 border-none p-5 flex flex-col">
 ...
 <Card className="rounded-[1.5rem] border-none p-5">
 ...
 <Card className="rounded-[1.5rem] border-none p-5 flex-1 flex flex-col">
 <div className="flex justify-between items-center mb-4">
 ...
 <Card className="rounded-[1.5rem] border-none p-5 lg:col-span-8 flex flex-col">
 <div className="flex justify-between items-center mb-4">
 ...
 className="pl-8 bg-white border-slate-200 dark:bg-slate-800 dark:border-slate-700 rounded-full h-8 text-xs w-40 focus-visible:ring-1 focus-visible:ring-[#ff5a36]" 
 />
 </div>
 ...
 className="bg-white border-slate-200 dark:bg-slate-800 dark:border-slate-700 rounded-full h-8 text-xs w-[130px] focus-visible:ring-1 focus-visible:ring-[#ff5a36]"
 />
 )}

 <DropdownMenu>
 <DropdownMenuTrigger className="rounded-full h-8 border px-3 text-xs font-medium flex items-center gap-1.5 cursor-pointer bg-white hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-800">
