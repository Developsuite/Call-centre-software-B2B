...
export default function ProcessorQueuePage() {
 ...
 {/* Mock Role Switcher */}
 <div className="flex items-center gap-4 z-20 relative bg-slate-100 dark:bg-slate-800/50 p-2 rounded-xl border w-fit">
 ...
 <Card className="col-span-1 p-4 rounded-2xl bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border-none shadow-[0_4px_10px_rgba(0,0,0,0.02)] flex flex-col justify-between group hover:-translate-y-0.5 transition-all duration-300">
 ...
 {/* Main Queue Table */}
 <Card className="rounded-[2rem] border border-[#ff5a36]/10 shadow-[0_8px_30px_rgba(255,90,54,0.04)] bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 flex-1 flex flex-col min-h-[500px] relative z-10 overflow-hidden mt-2">
