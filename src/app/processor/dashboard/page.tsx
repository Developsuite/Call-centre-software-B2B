...
export default function ProcessorDashboard() {
 ...
 {/* Main Action Card */}
 <Card className="rounded-[1.5rem] border-none bg-gradient-to-br from-[#ff7a5c] to-[#ff5a36] p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[220px]">
