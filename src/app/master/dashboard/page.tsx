...
export default function MasterDashboard() {
 ...
 <div className="text-center px-6 py-2 bg-slate-100 dark:bg-slate-800/50 rounded-xl border ">
 ...
 activeTab === "tenants" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36] border " : "text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800"
 )}
 >
 ...
 className={cn("px-4 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2", 
 activeTab === "users" ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-[#ff5a36] border " : "text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800"
 )}
 >
