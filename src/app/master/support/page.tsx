...
export default function SuperAdminSupportPage() {
 ...
 <div className="flex items-center justify-between relative z-10 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
 ...
 filter === status 
 ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-blue-600 dark:text-blue-400" 
 ...
 "rounded-[1.5rem] p-6 flex flex-col gap-4 border",
 ticket.status === "Open" ? "border-amber-200 dark:border-amber-900/30 bg-amber-50/30 dark:bg-amber-950/10" : "border-slate-100 dark:border-slate-800 bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300"
 )}>
 ...
 className="mt-4 w-full bg-[#ff5a36] hover:bg-[#e04a29] text-white font-bold h-10 rounded-xl text-sm transition-colors"
 >
 Mark as Resolved
 </button>
 )}
