...
export default function AgentSaleViewPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <Card className="rounded-[1.5rem] border border-slate-100 dark:border-border shadow-[0_4px_20px_rgba(0,0,0,0.03)] bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 p-6 flex flex-col h-full">
 ...
 ? "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 text-slate-800 dark:text-white border " 
 : "text-slate-500"
 )}
 >
 ...
 {/* Timeline Node */}
 <div className="relative z-10 w-6 h-6 rounded-full bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200/30 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-black/20 hover:bg-white/90 dark:hover:bg-slate-800/60 hover:shadow-2xl transition-all duration-300 border-2 border-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.3)] flex items-center justify-center shrink-0 mt-1">
